...
\noindent\textbf{\href{https://www.linkedin.com/company/alvora-group/}{Alvora}}
\hfill \textit{Technical Lead} — \textit{Oct 2025 – Present}
\begin{itemize}
  \item Developing a full-stack \textbf{operations platform} with role-based portals using \textbf{React}, \textbf{Node.js}, \textbf{TypeScript}, and \textbf{PostgreSQL}.
  \item Designing and integrating \textbf{microservices} for scheduling and data synchronization, enabling automated workflows and inter-service communication across the platform.
\end{itemize}
\vspace{0.2em}
\noindent\textbf{\href{https://www.linkedin.com/company/alvora-group/}{Alvora}}
\hfill \textit{Software Engineer} — \textit{Aug 2025 – Sep 2025}
\begin{itemize}
  \item Built a vacation rental monitoring platform scraping \textbf{\textasciitilde3,000 listings} across major rental marketplaces.
  \item Optimized bandwidth from \textbf{\textasciitilde2 MB to <30 KB} per property using \textbf{API-based data extraction}.
\end{itemize}
\vspace{0.4em}
